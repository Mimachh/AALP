...
const Entreprises = () => {
  ...
  return (
    <section ref={targetRef} className='w-full mb-16 flex flex-col items-center justify-center dark:text-light min-h-screen mt-[30vh]'>
        
        <Layout className='pt-8'>
            {/* Desktop */}
            <div className='lg:hidden relative h-[180vh] '>
                <div className='z-10 sticky top-8 xl:top-10 lg:top-16 md:top-8 xs:top-4'>
                    <AnimatedText text="Ils m'ont fait confiance" className='z-10 mb-16 lg:!text-7xl sm:!text-5xl xs:!text-4xl sm:mb-8' />
                </div>
