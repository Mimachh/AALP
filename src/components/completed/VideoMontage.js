  ...
  return (
    <section ref={targetRef} className=' w-full flex flex-col items-center justify-center dark:text-light min-h-screen mt-[2vh] mb-[50vh]'>
        ...
        <Layout className='pt-8'>
            <div className='lg:hidden relative h-[250vh]'>
                <div className='z-10 sticky top-8 xl:top-10 lg:top-16 md:top-8 xs:top-4'>
                    <AnimatedText text="Montage Video" className='z-10 mb-16 lg:!text-7xl sm:!text-5xl xs:!text-4xl sm:mb-8' />
                </div>
                ...
                <div  
                 ...
                 >
                    ...
                    >
                        <div className='absolute mt-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10'>
                        ...
                        <div>
                            <motion.video controls className='absolute mt-10 max-h-[800px]  top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 aspect-auto w-1/4'
                            style={{
                                opacity,
                                zIndex: z,
                            }}
